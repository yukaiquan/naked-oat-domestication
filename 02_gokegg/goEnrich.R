...
# Print program running progress
...
ego_MF <- enrichGO(
  gene = geneid, # differential gene vector
  keyType = "GID", # ID type of differential genes, must be supported by OrgDb
  OrgDb = org_db, # corresponding OrgDb
  ont = "MF", # GO category name, CC BP MF
  pvalueCutoff = 1,
  qvalueCutoff = 1,
  readable = FALSE
)
...
# Add a biological process column at the end
